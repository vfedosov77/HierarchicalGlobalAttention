...
# Layout: <repo>/ExistingModelFineTuning/TestModel40M/NotOptimized/<this file>
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))          # .../NotOptimized
MODEL_DIR = os.path.dirname(SCRIPT_DIR)                           # .../TestModel40M
EXISTING_DIR = os.path.dirname(MODEL_DIR)                         # .../ExistingModelFineTuning
ROOT_DIR = os.path.dirname(EXISTING_DIR)                          # repo root
...
DENSE_CHECKPOINT = os.path.join(EXISTING_DIR, "speed_run_dense_muon_final.pt")
...
def main():
    ...
    # Benchmark params
    parser.add_argument("--context-len", type=int, default=8000,
                        help="Number of context tokens for generation")
    parser.add_argument("--gen-tokens", type=int, default=192,
