...
A single self-contained ``HierarchicalGlobalAttention`` class serves every purpose:
...
class HierarchicalGlobalAttention(nn.Module):
    ...
    def _input_start_pos(cache: Any, layer_idx: int, cache_position: Optional[torch.Tensor]) -> int:
        ...
        return HierarchicalGlobalAttention._cache_seq_length(cache, layer_idx)
...
# Convenience aliases.
GlobalAttentionFused = HierarchicalGlobalAttention
GlobalAttention = HierarchicalGlobalAttention
