...
try:
    ...
    # This raw CUDA kernel targets sm_120 (fp8_e5m2) and won't JIT on older GPUs
    # (e.g. A4000/sm_86). It is only needed by FusedSoftcappedCrossEntropy; callers
    # on unsupported hardware must avoid that path.
