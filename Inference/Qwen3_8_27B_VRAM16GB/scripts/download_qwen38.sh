#!/usr/bin/env bash
# Download Unsloth UD-Q4_K_M GGUF for Qwen3.8-27B.
# Stock Qwen3.8-27B-Q4_K_M.gguf was removed upstream (404).
set -euo pipefail

DEST="${1:-${HGA_MODEL_DIR:-$HOME/models/Qwen3.8-27B-GGUF}}"
REPO="${HGA_HF_REPO:-unsloth/Qwen3.8-27B-GGUF}"
FILE="${HGA_GGUF_FILE:-Qwen3.8-27B-UD-Q4_K_M.gguf}"
...
# If this host has no Hugging Face access, copy the GGUF in:
#   scp Qwen3.8-27B-UD-Q4_K_M.gguf host:~/models/Qwen3.8-27B-GGUF/
